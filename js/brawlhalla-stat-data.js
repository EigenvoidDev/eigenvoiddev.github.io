...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll(".strength-resource-notes").forEach(item => {
    ...
    document.querySelectorAll(".dexterity-resource-notes").forEach(item => {
        item.addEventListener("click", function() {
            const content = this.getAttribute("data-content");
            showModal(content); // Show modal with specific content
        });
    ...
    document.querySelectorAll(".defense-resource-notes").forEach(item => {
        item.addEventListener("click", function() {
            const content = this.getAttribute("data-content");
            showModal(content); // Show modal with specific content
        });
    ...
    document.querySelectorAll(".speed-resource-notes").forEach(item => {
        item.addEventListener("click", function() {
            const content = this.getAttribute("data-content");
            showModal(content); // Show modal with specific content
        });
